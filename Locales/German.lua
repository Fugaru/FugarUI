...
L_MISC_UI_OUTDATED = "Deine Version von FugarUI ist veraltet. Du kannst die aktuelle Version von www.shestak.org laden"
...
-- Popups
L_POPUP_INSTALLUI = "Dies ist Ihre erste Benutzung von FugarUI mit diesem Charakter. Um das Interface zu konfigurieren, wird das UI nun neugeladen."
L_POPUP_RESETUI = "Sind Sie sich sicher, dass Sie die Einstellungen von FugarUI zurückgesetzen wollen?"
...
L_POPUP_DISABLEUI = "FugarUI funktioniert nicht mit deiner Auflösung, möchtest du FugarUI ausschalten? (Drücke Abbrechen, falls du eine andere Auflösung testen willst)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Willkommen bei FugarUI "
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Zurücksetzen der FugarUI_Config Einstellungen.",
