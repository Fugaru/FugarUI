...
L_MISC_UI_OUTDATED = "Tu versión de FugarUI no está actualizada. Puedes descargar la última versión de www.shestak.org"
...
-- Popups
L_POPUP_INSTALLUI = "Es la primera vez que usas FugarUI con este personaje. Usted debe volver a cargar la interfaz de usuario para configurarlo."
L_POPUP_RESETUI = "¿Estás seguro de que desea restablecer FugarUI?"
...
L_POPUP_DISABLEUI = "FugarUI no funciona con esta resolución, ¿Quieres desactivar FugarUI? (Pulsa cancelar si quieres probar otra resolución)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Bienvenido a FugarUI "
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Reinicia la configuración de FugarUI_Config.",
