...
L_MISC_UI_OUTDATED = "Une version plus récente de FugarUI est disponible. Vous pouvez la télécharger www.shestak.org"
...
-- Popups
L_POPUP_INSTALLUI = "Première utilisation de FugarUI avec ce personnage. Vous devez recharger l'interface utilisateur pour le configurer."
L_POPUP_RESETUI = "Etes-vous sûr de vouloir réinitialiser FugarUI ?"
...
L_POPUP_DISABLEUI = "FugarUI ne fonctionne pas avec cette résolution, voulez-vous désactiver FugarUI ? (Annuler si vous souhaitez essayer une autre résolution)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Bienvenue sur FugarUI "
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Remet les paramètres FugarUI_Config à leurs valeurs par défaut.",
