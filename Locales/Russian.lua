...
L_MISC_UI_OUTDATED = "Ваша версия FugarUI устарела. Вы можете скачать последнюю версию с www.shestak.org"
...
-- Popups
L_POPUP_INSTALLUI = "Это первый запуск FugarUI для этого персонажа. Необходимо перезагрузить интерфейс для его настройки."
L_POPUP_RESETUI = "Вы уверены, что хотите сбросить настройки FugarUI?"
...
L_POPUP_DISABLEUI = "FugarUI не работает на этом разрешении, хотите отключить FugarUI? (Отмена, если хотите попробовать другое разрешение)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Добро пожаловать в FugarUI "
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Сброс настроек FugarUI_Config.",
