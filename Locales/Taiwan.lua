...
L_MISC_UI_OUTDATED = "FugarUI 版本已過期，請至 www.shestak.org 下載最新版"
...
-- Popups
L_POPUP_INSTALLUI = "該角色首次使用FugarUI.你必須重新加載UI來配置."
L_POPUP_RESETUI = "你確定要重新加載FugarUI?"
L_POPUP_RESETSTATS = "你確定要重置本次遊戲時間和金幣收益統計數據嗎?"
L_POPUP_SWITCH_RAID = "選擇團隊佈局."
L_POPUP_DISBAND_RAID = "你確定要解散團隊?"
L_POPUP_DISABLEUI = "FugarUI並不支援此解析度, 你想要停用FugarUI嗎? (若果您想要嘗試其他解析度, 請按取消)"
