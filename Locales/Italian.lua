...
L_MISC_UI_OUTDATED = "La tua versione della FugarUI non è aggiornata: puoi scaricare la nuova versione da www.shestak.org."
...
-- Popups
L_POPUP_INSTALLUI = "È la prima volta che utilizzi la FugarUI con questo personaggio. Devi riavviare l'interfaccia utente per configurarla."
L_POPUP_RESETUI = "Vuoi davvero ripristinare tutte le impostazioni iniziali della FugarUI?"
...
L_POPUP_DISABLEUI = "A questa risoluzione la FugarUI non funziona correttamente, vuoi disabilitare l'AddOn (clicca 'Cancella' se vuoi provare con un'altra risoluzione)?"
...
-- Welcome message
L_WELCOME_LINE_1 = "Benvenuto/a in FugarUI "
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Riporta le impostazioni della FugarUI_Config a quelle iniziali.",
